...
$config['db']['master']['host'] = '198.44.250.174:888';

$config['db']['master']['username'] = 'hskj';

$config['db']['master']['password'] = 'iZzik6tRjeYitHK4';

$config['db']['master']['port'] = '3306';

$config['db']['master']['database'] = 'hskj';
...
$config['setting']['authkey'] = '80e894ff';
