...
<div class="page-header"><img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary">公告管理</span></div>
    ...
    <form action="./index.php" method="get" class="form-horizontal  ">
        ...
        <div class="page-toolbar row m-b-sm m-t-sm">
            ...
            <div class="col-md-4 pull-left">
                ...
                <a class='btn btn-primary btn-sm' href="<?php  echo webUrl('shop/notice/add')?>"><i class='icon-dalaba'></i> 添加公告</a>
            ...
            <div class="col-md-6 pull-right">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-select">
                        ...
                        <!-- 下拉框(隐藏) -->   
                        <select name="status" class='form-control' style="position: relative;z-index: -99">
