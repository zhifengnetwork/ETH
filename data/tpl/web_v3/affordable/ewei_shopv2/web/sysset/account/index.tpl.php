...
<div class="page-header">
    ...
    <img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary">APP切换</span>
            ...
            <div class="search-form">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input type="search" placeholder="请输入App名称" name="keyword" class="form-control">
