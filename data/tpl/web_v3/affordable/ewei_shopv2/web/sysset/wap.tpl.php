...
<div class="page-header"><img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary">全网通设置</span></div>
    ...
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
        ...
        <div class="tabs-container">
            ...
            <ul class="nav nav-tabs" id="myTab">
                ...
                <li class="active"><a href="#tab_basic" class="fourX">基本设置</a></li>

                <li><a href="#tab_style" class="fourX">样式设置</a></li>

                <li><a href="#tab_sms" class="five">验证码<!-- 短信 -->模板</a></li>

                <?php  if(com('h5app')) { ?>

                <li><a href="#tab_login" class="five">APP登录设置</a></li>

                <li><a href="#tab_style_app" class="five">APP样式设置</a></li>
