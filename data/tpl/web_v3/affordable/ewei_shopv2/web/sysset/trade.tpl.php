...
<div class="page-header"><img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary">交易设置</span></div>
...
<div class="page-content">
 ...
 -->
        ...
        <div class='form-group-title'>提现设置</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <span class='help-block'>余额达到该倍数才能提现,空或0不限制</span>
...
<div class="form-group recharge-group">
    ...
    <label class="col-lg control-label">会员投资额上限</label>
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class="input-group fixsingle-input-group">
            ...
            <div class="input-group-addon">投资额</div>

        </div>

        <span class='help-block text-danger'>会员最高投资额，0为不限制(会员积分大于等于此值时将无法继续增加，后台手动充值不限制，已持有积分不限制)</span>
