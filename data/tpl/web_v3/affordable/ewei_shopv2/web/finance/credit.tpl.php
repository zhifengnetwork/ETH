...
<div class="page-header"><img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary"><?php  if($type=='credit1') { ?>积分<?php  } else { ?>余额<?php  } ?>明细</span></div>
