        ...
        <div class="col-md-12">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <th style='width:150px;text-align: center;'>提现地址</th>

                    <th style='width:150px;text-align: center;'>二维码</th>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                         ...
                         <?php  if($row['status']==0) { ?>
                            <a  class='btn btn-op btn-primary' data-toggle='ajaxPost' data-confirm="确认拒绝提现申请?" href="<?php  echo webUrl('finance/log/apply',array('id' => $row['id'],'type'=>1));?>">
