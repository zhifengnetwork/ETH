<?php defined('IN_IA') or exit('Access Denied');?><script type="text/javascript" src="./resource/components/ueditor/ueditor.config.js"></script>
...
<textarea id="editor" name="editor" type="text/plain" style="height:550px;"><?php  echo $article['article_content'];?></textarea>
