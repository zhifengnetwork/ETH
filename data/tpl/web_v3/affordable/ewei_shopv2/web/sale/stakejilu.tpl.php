            ...
            <div class="input-group">
                ...
                <span class="input-group-select">
                    ...
                    <select name="type" class="form-control"   style="width:120px;"  >
                        ...
                        <option value="" <?php  if(empty($_GPC['type'])) { ?>selected<?php  } ?>>开奖状态</option>

                            <option value="-1" <?php  if($_GPC['type']=='-1') { ?>selected<?php  } ?>>未开奖</option>

                            <option value="1" <?php  if($_GPC['type']=='1') { ?>selected<?php  } ?>>已开奖</option>
        ...
        <div class="col-md-12">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td><?php  if($row['endtime']) { ?><?php  echo date('Y-m-d',$row['endtime'])?><br/><?php  echo date('H:i',$row['endtime'])?><?php  } ?></td>
                <?php  } } ?>
