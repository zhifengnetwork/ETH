...
<div class="page-header">
    ...
    <img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary">分销商管理 </span>
...
<div class="page-content">
   ...
   <form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
        ...
        <div class="page-toolbar m-b-sm m-t-sm">
            ...
            <span class="pull-left"><?php  echo tpl_daterange('time', array('sm'=>true, 'placeholder'=>'成为动态会员时间'),true);?></span>
           ...
           <tr >
                ...
                <td style="overflow: visible">
                    ...
                    <?php  if(!empty($row['parentavatar'])) { ?>
                         ...
                         <img class='radius50' src='<?php  echo $_W['attachurl'];?><?php  echo $row['parentavatar'];?>' style='width:20px;height:20px;padding1px;border:1px solid #ccc' onerror='this.src='../addons/ewei_shopv2/static/images/noface.png''/>
                ...
                <td><p>动态等级：<?php  if(empty($row['levelname'])) { ?> <?php echo empty($this->set['levelname'])?'普通等级':$this->set['levelname']?><?php  } else { ?><?php  echo $row['levelname'];?><?php  } ?></p>
                    <p>管理等级：<?php  if($row['levelname2']) { ?><?php  echo $row['levelname2'];?><?php  } else { ?>暂无<?php  } ?></p>
                    <p>领导等级：<?php  if($row['levelname3']) { ?><?php  echo $row['levelname3'];?><?php  } else { ?>暂无<?php  } ?></p>
                </td>
