<?php defined('IN_IA') or exit('Access Denied');?> <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('_header', TEMPLATE_INCLUDEPATH)) : (include template('_header', TEMPLATE_INCLUDEPATH));?>
 ...
 <div class="page-header">
     ...
     当前位置：<span class="text-primary">领导奖等级</span>
            ...
            <table class="table table-responsive table-hover">
                ...
                <tbody>
                    ...
                    <tr <?php  if($row['id']=='default') { ?>style='background:#f2f2f2'<?php  } ?>>
                        ...
                        <td><?php  if($row['ordercount']) { ?>直推<?php  echo $row['ordercount'];?>个和团队总人数<?php  echo $row['downcount'];?><?php  } else { ?>不自动升级<?php  } ?></td>
                        ...
                        <td>
                            ...
                            <a class='btn btn-default btn-sm btn-op btn-operation' data-toggle='ajaxModal'  href="<?php  echo webUrl('commission/level3/edit', array('id' => $row['id']))?>">
