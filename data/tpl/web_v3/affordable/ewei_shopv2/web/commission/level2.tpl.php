<?php defined('IN_IA') or exit('Access Denied');?> <?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('_header', TEMPLATE_INCLUDEPATH)) : (include template('_header', TEMPLATE_INCLUDEPATH));?>
 ...
 <div class="page-header">
     ...
     当前位置：<span class="text-primary">管理奖等级</span>
                ...
                <tbody>
                    ...
                    <tr <?php  if($row['id']=='default') { ?>style='background:#f2f2f2'<?php  } ?>>
                        ...
                        <td>
                            ...
                            <a class='btn btn-default btn-sm btn-op btn-operation' data-toggle='ajaxModal'  href="<?php  echo webUrl('commission/level2/edit', array('id' => $row['id']))?>">
