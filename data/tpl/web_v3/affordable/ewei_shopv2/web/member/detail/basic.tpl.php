...
<div class="form-group">
    ...
    <label class="col-lg control-label">ETH</label>
    ...
    <div class="col-sm-6">
        ...
        <div class="checkbox col-sm-3">
            <label class="checkbox" for="addBehaviorOnToastClick">
                <input id="addBehaviorOnToastClick" type="checkbox" value="checked" class="input-mini" />冻结15天
            </label>
        </div>
        <div class="checkbox col-sm-3">
            <label class="checkbox" for="debugInfo">
                <input id="debugInfo" type="checkbox" value="checked" class="input-mini" />冻结30天
            </label>
        </div>
        <div class="checkbox col-sm-3">
            <label class="checkbox" for="preventDuplicates">
                <input id="preventDuplicates" type="checkbox" value="checked" class="input-mini" />永久冻结
            </label>
        </div>
    </div>
</div>
