...
<html lang="zh-cn">
    ...
    <head>
        ...
        <title><?php  if(!empty($copyright) && !empty($copyright['title'])) { ?><?php  echo $copyright['title'];?><?php  } ?>海生商城</title>
        ...
        <link href="<?php  echo EWEI_SHOPV2_LOCAL?>static/css/common_v3.css?v=2.1.1" rel="stylesheet">
        ...
        <link rel="stylesheet" type="text/css" href="../addons/ewei_shopv2/static/css1/style.css">
