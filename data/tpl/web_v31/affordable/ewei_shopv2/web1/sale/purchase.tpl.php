...
<div class="page-header"><img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary">买入记录</span></div>
    ...
    <form action="./index.php" method="get" class="form-horizontal table-search" role="form" id="form1">
        ...
        <div class="page-toolbar">
            ...
            <span class="pull-left">
                    ...
                    <?php  echo tpl_daterange('time', array('sm'=>true,'placeholder'=>'买入订单创建时间'),true);?>
        ...
        <div class="col-md-12">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <th style='width:200px'>买入人</th>

                    <th style='width:200px;'>购买人</th>

                    <th style='width:100px;'>买入币</th>

                    <th style='width:100px;'>卖出金额</th>

                    <th style='width:200px;'>买入时间</th>
