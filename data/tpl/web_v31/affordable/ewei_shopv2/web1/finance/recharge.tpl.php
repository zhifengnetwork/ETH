...
<form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
    ...
    <input type='hidden' name='type' value="credit2" />
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
                ...
                <div class="tabs-container">
                    ...
                    <div class="tabs">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a data-toggle="tab" href="#tab-1" data-rechargetype="credit2" aria-expanded="true"> 充值余额</a></li>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <label class='radio-inline'>
                            ...
                            <input type='radio' name='changetype' value='2' /> 最终<span class='name'>余额</span>
            ...
            <button class="btn btn-primary btn-submit" type="submit">确认充值余额</button>
