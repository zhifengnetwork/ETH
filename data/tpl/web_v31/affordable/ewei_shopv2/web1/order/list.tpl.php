...
<div class="page-header">
    ...
    <img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary">订单管理</span>
                        ...
                        <div class="list-inner paystyle"  style='text-align:center;' >
                            ...
                            <?php  } else if($item['statusvalue'] == 0) { ?>
                                ...
                                <?php  if($item['paytypevalue']!=3) { ?>
                                    <?php  if($item['zf']=="wx") { ?>
                                        <label class='label label-default'>微信支付</label>
                                    <?php  } else if($item['zf']=="zfb") { ?>
                                        <label class='label label-default'>支付宝支付</label>
                                    <?php  } else if($item['zf']=="yhk") { ?>
                                        <label class='label label-default'>银行卡支付</label>
                                    <?php  } else { ?>
                                         <label class='label label-default'>未上传支付凭证</label>
                                    <?php  } ?>
                                <?php  } else { ?>
