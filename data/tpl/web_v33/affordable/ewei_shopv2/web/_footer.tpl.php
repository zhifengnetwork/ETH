...
<script type="text/javascript">
    $(function(){
        $(document).on('click','.menu-header',function(){
            var that = $(this).children().eq(0);
            if(that.hasClass('icon-uniE901')){
                that.addClass('icon-1').removeClass('icon-uniE901');
            }else if(that.hasClass('icon-1')){
                that.addClass('icon-uniE901').removeClass('icon-1');
            }
        })
    })
</script>
