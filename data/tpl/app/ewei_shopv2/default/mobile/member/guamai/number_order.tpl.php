...
======= -->
			...
			<div class="mask0_box hide">
				...
				<div class="mask0 hide">
					<p>价格(CNY)</p>
					<div class="mask_lis">
						<input type="number" oninput="clearNoNum(this)" placeholder="请输入卖出的价格" class="maiChu_price">
					...
					<div class="mask_lis">
						...
						<input type="number" oninput="clearNoNum(this)" placeholder="请输入卖出的数量" class="maiChu_Num">
					</div>
					<div class="mask_lis">
						<p>预获金额(CNY)</p>
				...
				<div class="mask1">
					<div class="mask1_pice">
						<p>价格(CNY)</p>
						<input type="number" min="0" oninput="clearNoNum(this)" placeholder="请输入买入的价格" class="maiRu_price">
					</div>
					...
					<div class="mask1_lis">
						<input type="number " min="0" oninput="clearNoNum(this)" placeholder="请输入购买的数量" class="buyNum ">
					</div>
					<div class="mask_lis">
						<p>预获币数(ETH)</p>
						<input class="mask_lis_input getMoney0" type="number" disabled value="0">
			...
			<script type="text/javascript" src="../../../../../../../app/themes/chengzi_bphweizhan/js/jquery-1.8.2.min.js">
			</script>
			<!---交易倒计时----->
			<script>
...
<script type="text/javascript">
	...
	$('.buyNum,.maiChu_Num').focus(function () {
		var advertising = $('.advertising').prop("scrollHeight") + $('.fui-header').prop("scrollHeight") + $('.box_nav')
			.prop("scrollHeight");
