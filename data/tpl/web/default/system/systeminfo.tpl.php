...
<div class="main">
	...
	<table class="table we7-table table-hover site-list">
		...
		<tr>
			<td class="text-left">海生程序版本</td>
			<td class="text-left">HaiSheng <?php  echo IMS_VERSION;?> Release <?php  echo IMS_RELEASE_DATE;?> &nbsp; &nbsp;
			</td>
		</tr>
		<tr>
			<td class="text-left">产品系列</td>
			<td class="text-left"><?php  if(IMS_FAMILY == 'v') { ?> 您的产品是商业版 <?php  } else { ?> 您的产品是商业版 <?php  } ?>
			</td>
		</tr>
		<tr>
