				...
				<table class="table we7-table table-hover fans-info vertical-middle">
					...
					<tr>
						...
						<td>
							...
							<a href="<?php  echo url('mc/member/post', array('uid' => $fan['uid'],'openid' => $fan['openid'], 'fanid' => $fan['fanid']));?>" class="text-danger" title="该用户尚未注册会员，请为其手动注册！">[ 注册为会员 ]</a>
							<?php  } else { ?>
							<p class="remark-name"><a href="<?php  echo url('mc/member/post', array('uid' => $fan['uid']));?>">
