...
<head>
    ...
    <meta name="keywords" content="<?php  echo $basicset['keywords'];?>" />
    <meta name="description" content="<?php  echo $basicset['description'];?>" />
...
<header id="header">
    <div class="lynn-head">
        ...
        <?php  if(isset($_GET['c']) && ($_GET['c']=='register' || $_GPC['c']=='login')) { ?>
        <?php  } else { ?>
        <div id="lynn-login">
            ...
            <?php  } ?>
            <?php  if(!empty($setting['register']['open'])) { ?><a href="<?php  echo webUrl('register/index')?>" class="active">注册</a><?php  } ?>
        </div>
        <?php  } ?>
