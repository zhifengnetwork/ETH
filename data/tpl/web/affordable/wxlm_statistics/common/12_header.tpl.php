		...
		<div class="container <?php  if(!empty($frames['section']['platform_module_menu']['plugin_menu'])) { ?>plugin-head<?php  } ?>">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-left">
					<?php  global $top_nav?>
					<?php  if(is_array($top_nav)) { foreach($top_nav as $nav) { ?>					<?php  if($nav['title']!="小程序" && $nav['title']!="公众号"){					?>						<li<?php  if(FRAME == $nav['name']) { ?> class="active"<?php  } ?>><a href="<?php  if(empty($nav['url'])) { ?><?php  echo url('home/welcome/' . $nav['name']);?><?php  } else { ?><?php  echo $nav['url'];?><?php  } ?>" <?php  if(!empty($nav['blank'])) { ?>target="_blank"<?php  } ?>><?php  echo $nav['title'];?></a></li>					<?php 					}?>
...
<div class="container">
	<?php  if(in_array(FRAME, array('account', 'system', 'upgrade', 'wxapp', 'site')) && !in_array($_GPC['a'], array('news-show', 'notice-show'))) { ?>
	...
	<div class="panel panel-content main-panel-content <?php  if(!empty($frames['section']['platform_module_menu']['plugin_menu'])) { ?>panel-content-plugin<?php  } ?>">
		<div class="content-head panel-heading main-panel-heading">
			...
			<?php  } ?>
			<?php  if(FRAME == 'upgrade') { ?>
				<span class="font-lg"><i class="wi wi-system-site"></i> 系统升级</span>
			<?php  } ?>
			<?php  if(FRAME == 'wxapp') { ?>
	...
	<div class="panel-body clearfix main-panel-body <?php  if(!empty($_W['setting']['copyright']['leftmenufixed'])) { ?>menu-fixed<?php  } ?>">
		<div class="left-menu">
			...
			<?php  if(empty($frames['section']['platform_module_menu']['plugin_menu'])) { ?>
				...
				<?php  if($frame_section['title']!="小程序" &&  $frame_section['title']!="常用工具" &&  $frame_section['title']!="权限管理") { ?>
				...
				<div class="panel panel-menu">
					...
					<div class="panel-heading">
						<span class="no-collapse">
							<?php  if($frame_section['title']=="公众号") { ?>
								APP
							<?php  } else { ?>
								<?php  echo $frame_section['title'];?>
							<?php  } ?>
