...
<div class="page-header"><img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary">转账记录</span></div>
...
<div class="page-content">
    ...
    <form action="./index.php" method="get" class="form-horizontal table-search" role="form" id="form1">
        ...
        <input type="hidden" name="r" value="finance.log.zhuanzhang" />

        <div class="page-toolbar">

            <!-- <span class="pull-left">

                    <?php  echo tpl_daterange('time', array('sm'=>true,'placeholder'=>'转账时间'),true);?>
...
<<<<<<< HEAD
                    <th style='width:5%;'>转账id</th>

                    <th style="width: 10%;">转账人</th>
