...
<div class="page-header"><img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary">幻灯片管理</span></div>
        ...
        <div class="page-toolbar">
            ...
            <div class="pull-left">
                ...
                <?php if(cv('shop.adv.add')) { ?>
                    ...
                    <a class='btn btn-primary btn-sm' href="<?php  echo webUrl('shop/adv/add')?>"><i class='icon-huandeng'></i> 添加幻灯片</a>
            ...
            <div class="pull-right col-md-6">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-select">
                        <!-- 单选按钮式选择 -->
                        <p class="status-font">状态：</p>
                        <div class="status">
                            <input type="radio" name="status" value="1" id="xianshi" ><label for="xianshi">显示</label>
                            <br>
                            <input type="radio" name="status" value="0" id="yincang" ><label for="yincang">隐藏</label>
                        </div>
                        <!-- 下拉框(隐藏) -->
                        <select name="enabled" class='form-control' style="position: relative;z-index: -99">
