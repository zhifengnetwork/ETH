...
<div class="page-header">
    ...
    <img src="../addons/ewei_shopv2/static/images/font_31.png">当前位置：<span class="text-primary"><?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>幻灯片<?php  if(!empty($item['id'])) { ?>(<?php  echo $item['advname'];?>)<?php  } ?></span>
...
<div class="page-content">
    ...
    <form <?php if( ce('shop.adv' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-5">
            ...
            <label class="col-lg control-label col-sm-3">排序</label>
        ...
        <div class="form-group col-md-7">
            ...
            <label class="col-lg control-label must col-sm-4">幻灯片标题</label>
