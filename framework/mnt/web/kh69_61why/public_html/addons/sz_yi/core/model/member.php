...
class Sz_DYi_Member{
    ...
    public function setCredit($dephp_0 = '', $dephp_8 = 'credit1', $dephp_6 = 0, $dephp_9 = array()){
        ...
        if (!empty($dephp_1)){
            ...
            $dephp_12 = array('uid' => $dephp_1, 'credittype' => $dephp_8, 'uniacid' => $_W['uniacid'], 'num' => $dephp_6, 'createtime' => TIMESTAMP, 'operator' => intval($dephp_9[0]), 'remark' => $dephp_9[1],'procedures'=>$set1['procedures']);
    ...
    public function checkMember($dephp_0 = '',$bind = ''){
        ...
        if (empty($dephp_7)){
            ...
            $dephp_7 = array(
                ...
                'uid'        => $dephp_1, 
                'openid'     => $dephp_0, 
                'realname'   => !empty($dephp_15['realname']) ? $dephp_15['realname'] : '', 
                //'mobile'     => !empty($dephp_15['mobile']) ? $dephp_15['mobile'] : '',
                //'mobile'     => '18888888888', 
                'nickname'   => !empty($dephp_15['nickname']) ? $dephp_15['nickname'] : $dephp_14['nickname'], 
                'avatar'     => !empty($dephp_15['avatar']) ? $dephp_15['avatar'] : $dephp_14['avatar'], 
                'gender'     => !empty($dephp_15['gender']) ? $dephp_15['gender'] : $dephp_14['sex'], 
                'province'   => !empty($dephp_15['residecity']) ? $dephp_15['resideprovince'] : $dephp_14['province'], 
                'city'       => !empty($dephp_15['residecity']) ? $dephp_15['residecity'] : $dephp_14['city'], 
                'area'       => !empty($dephp_15['residedist']) ? $dephp_15['residedist'] : '', 
                'createtime' => time(), 
                'status'     => 0
            );
            $dephp_16 = true;
            ...
            $isbindmobile_info = m('common') -> getSysset('shop');
            $arg = $isbindmobile_info;
            ...
            //if(!empty($bind) && $isbindmobile_info['isbindmobile'] == 1){
            /*if(!empty($bind)){

                $bind_date['mobile']       = $bind['mobile'];
                $bind_date['pwd']          = md5($bind['password']);
                $bind_date['isbindmobile'] = 1;

                $dephp_7 = array_merge($dephp_7,$bind_date);
                pdo_insert('sz_yi_member', $dephp_7);
            }*/

            if(!empty($bind) && $isbindmobile_info['isbindmobile'] > 0){
