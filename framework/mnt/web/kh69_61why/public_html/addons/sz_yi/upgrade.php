...
if(!pdo_fieldexists('sz_yi_goods', 'returnmatter')) {
  pdo_query("ALTER TABLE ".tablename('sz_yi_goods')." ADD   `returnmatter` TINYINT( 11 )   NOT NULL DEFAULT  '0'   COMMENT  '购物返' ;");
}
if(!pdo_fieldexists('sz_yi_order', 'returnmatter')) {
  pdo_query("ALTER TABLE ".tablename('sz_yi_order')." ADD   `returnmatter` TINYINT( 11 )   NOT NULL DEFAULT  '0'   COMMENT  '购物返' ;");
}
