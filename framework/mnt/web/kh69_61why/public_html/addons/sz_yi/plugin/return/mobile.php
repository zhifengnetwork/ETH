										   ...
										   if(empty($member['uid'])){
													//member表
														if($spare !=0){
															...
															pdo_update('sz_yi_return',array('return_money' => $spare),array('uniacid' => $_W['uniacid'],'id' => $val['id']));
														
														}else{
															pdo_insert('sz_yi_return_money',$data);
															pdo_insert('mc_credits_record',$mc_credits_record);
															pdo_update('sz_yi_member',array('credit2' => $addmoney),array('uniacid' => $_W['uniacid'],'openid' => $val['openid']));
															pdo_update('sz_yi_return',array('return_money' => $spare,'status' =>1),array('uniacid' => $_W['uniacid'],'id' => $val['id']));
