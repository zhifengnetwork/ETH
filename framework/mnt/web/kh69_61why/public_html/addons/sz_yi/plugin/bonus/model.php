...
if (!class_exists('BonusModel')){
    class BonusModel extends PluginModel{
        ...
        public function getParentAgents($dephp_1, $dephp_2 = 0){
            global $_W;
            ...
            if(empty($dephp_4)){
                ...
                if(empty($this -> parentAgents[$dephp_4['bonuslevel']])){
                    $this -> parentAgents[$dephp_4['bonuslevel']] = $dephp_4['id'];
                }
                if($dephp_4['agentid'] != 0){
                    return $this -> getParentAgents($dephp_4['agentid']);
                }else{
                    return $this -> parentAgents;
                }
            }
        ...
        public function calculate($dephp_5 = 0, $dephp_6 = true){
            ...
            $dephp_8 = time();
            $dephp_9 = pdo_fetch('select openid, address from ' . tablename('sz_yi_order') . ' where id=:id limit 1', array(':id' => $dephp_5));
            ...
            foreach ($dephp_12 as $dephp_14){
                ...
                if(!empty($dephp_16)){
                    $dephp_17 = $this -> getParentAgents($dephp_16, 1);
                    $dephp_18 = 0;
                ...
                if(!empty($dephp_0['area_start'])){
                    $dephp_26 = 0;
                    $dephp_27 = floatval($dephp_0['bonus_commission3']);
                    if(!empty($dephp_27)){
                        ...
                        if(!empty($dephp_28)){
                            if($dephp_28['bonus_area_commission'] > 0){
