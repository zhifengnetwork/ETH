...
if ($operation == 'display') {
    ...
    foreach( $list_group as $row1){
	   ...
	   $asd[$row1['mid']]['unreturnmoney'] = number_format($asd[$row1['mid']]['money1'] - $asd[$row1['mid']]['return_money1'], 2);
...
//echo "<pre>"; print_r($_GPC);exit;
    ...
    foreach ($list_group as $key => $value) {
		$list_group[$key]['unreturnmoney']  = number_format($value['money'] - $value['return_money'], 2);
