...
if ($operation == 'display') {
 ...
 " where  yi_goodsid=".$_GPC['goodsid']." and  uniacid=".$_W['uniacid']."");
   /*$umss = pdo_fetchall("SELECT * FROM " . tablename('yipinyima') . " d " .
	...
	$first_desc=$item_desc['first_desc'];
	$score_desc=$item_desc['score_desc'];
	$score_xianjin=$item_desc['score_xianjin'];
	$score_youhuijuan=$item_desc['score_youhuijuan'];
	$second_desc=$item_desc['second_desc'];
	$oldtime_desc=$item_desc['oldtime_desc'];
