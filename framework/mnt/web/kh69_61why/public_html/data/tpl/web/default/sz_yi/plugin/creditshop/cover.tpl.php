...
<form id="setform"  action="" method="post" class="form-horizontal form" onclick='return formcheck()'>
    <div class='panel panel-default'>
        <div class='panel-heading'>积分商城心入口设置</div>
        <div class='panel-body'>
        	<div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-1 control-label">直接链接</label>
            ...
            <div class="form-group">
               	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                ...
	                <div class="col-sm-9">
	                    <label class="radio-inline"><input type="radio" name="cover[status]" value="0" <?php  if(empty($rule['status'])) { ?> checked="checked"<?php  } ?>/>禁用</label>
	                    <label class="radio-inline"><input type="radio" name="cover[status]" value="1" <?php  if($rule['status']==1) { ?> checked="checked"<?php  } ?>/>启用</label>
	                </div>
                </div>
            </div>
