...
<form action="" method="get" class='form form-horizontal'>
        ...
        <div class="panel-body">
            <form action="./index.php" method="get" class="form-horizontal" plugins="form">
                ...
                <div class="form-group">					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                  <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label">关键词</label>	
	                ...
	                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">	
	                    <label class="col-xs-12 col-sm-2 col-md-3 col-lg-2 control-label">按时间</label>	
	                     <div class="col-sm-3">	
                 ...
                 <div class="form-group">					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	                    <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label">操作类型</label>	
	                    <div class="col-xs-12 col-sm-9 col-lg-7">	
    ...
    <div class='panel panel-default'>
        <div class='panel-heading' >操作日志 (数量: <?php  echo $total;?>  条)</div>
        <div class=''>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class='btn btn-default'  href="<?php  echo $this->createPluginWebUrl('perm/log', array('op' => 'delete', 'id' => $row['id']))?>" onclick="return confirm('确认删除此操作员吗？');return false;" style="background-color: #000; color:#fff;"><i class="fa fa-remove"></i></a></td>
                        <?php  } ?>
                    </tr>
                    <?php  } } ?>
