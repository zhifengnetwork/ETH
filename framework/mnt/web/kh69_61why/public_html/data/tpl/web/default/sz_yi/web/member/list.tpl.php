    ...
    <div class="table-responsive">
        <table class="table table-hover" style="overflow:visible;">
		  ...
		  <?php  } ?>
                    ...
                    <td><?php  if(empty($row['levelname'])) { ?>vip1<?php  } else { ?><?php  echo $row['levelname'];?><?php  } ?>
                ...
                <table  class="table table-bordered">
                    ...
                    <tr><td><img style='width:100px;height:100px;padding:1px;border:1px solid #ccc' src='<?php  echo $member['avatar'];?>' style='width:100px;height:100px;padding:1px;border:1px solid #ccc' />
                      ...
                      <select name='data[level]' class='form-control'>
                        ...
                        <option value=''><?php echo empty($shop['levelname'])?'vip1':$shop['levelname']?></option>
                    ...
                    <div class='form-control-static'>
                        ...
                        <?php echo empty($shop['levelname'])?'vip1':$shop['levelname']?>
                    ...
                    <?php  } ?></td>
                        ...
                        <td>
                                ...
                                <div class='form-control-static'><?php  echo $zyw;?></div>
                    ...
                    <td><div class="">
                        ...
                        <td><div class="">
                         ...
                         <td>
                                ...
                                <div class='form-control-static'><?php  echo $zyw_1;?></div>
