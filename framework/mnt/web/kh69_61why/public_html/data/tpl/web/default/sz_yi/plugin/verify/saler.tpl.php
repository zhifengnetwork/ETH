...
<div class="main">
    <form <?php if( ce('verify.saler' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form" enctype="multipart/form-data">
        ...
        <div class='panel panel-default' style="background-color: transparent; border: none;">
        	<div class="border_bg">
            	<div class='panel-heading'>核销员设置</div>
	            <div class='panel-body'>
	                <div class="form-group">
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label"><span style='color:red'>*</span> 选择核销员</label>
	                ...
	                <div class="form-group">
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label"><span style='color:red'>*</span> 核销员姓名</label>
		                    <div class="col-sm-9 col-xs-12">
		                        <?php if( ce('verify.saler' ,$item) ) { ?>
	                 ...
	                 <div class="form-group">
	                 	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">所属门店</label>
		                    <div class="col-sm-9 col-xs-12">
		                            <?php if( ce('verify.saler' ,$item) ) { ?>
...
<form action="" method="post" onsubmit="return formcheck(this)">
    <div class='panel panel-default'>
        <div class='panel-heading'>核销员管理</div>
        <div class=''>
            <table class="table">
                <thead>
                    <tr><th>核销员</th>
                ...
                <tbody>
                    ...
                    <tr><td><img src='<?php  echo $row['avatar'];?>' style='width:30px;height:30px;padding1px;border:1px solid #ccc' /> <?php  echo $row['nickname'];?></td>
                        ...
                        <td><?php if(cv('verify.saler.view|verify.saler.edit')) { ?><a class='btn btn-default' href="<?php  echo $this->createPluginWebUrl('verify/saler', array('op' => 'post', 'id' => $row['id']))?>"><i class='fa fa-edit'></i></a><?php  } ?>
