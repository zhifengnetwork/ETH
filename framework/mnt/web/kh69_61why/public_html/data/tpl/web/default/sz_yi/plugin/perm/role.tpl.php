	        ...
	        <div class="panel-body">
	            <form action="./index.php" method="get" class="form-horizontal" role="form">
	                ...
	                <div class="form-group">
		                ...
		                <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 col-lg-2 control-label">状态</label>
		                    <div class="col-xs-12 col-sm-9 col-lg-9">
        	...
        	<div class=''>
	            <table class="table">
	                ...
	                <tbody>	
	                    ...
	                    <tr><td><?php  echo $row['rolename'];?></td>
	                        ...
	                        <td><?php if(cv('perm.role.edit|perm.role.view')) { ?><a class='btn btn-default' href="<?php  echo $this->createPluginWebUrl('perm/role', array('op' => 'post', 'id' => $row['id']))?>" style="background-color: #ffb034; color:#fff;"><i class="fa fa-edit"></i></a><?php  } ?>
	                          <?php if(cv('perm.role.delete')) { ?><a class='btn btn-default'  href="<?php  echo $this->createPluginWebUrl('perm/role', array('op' => 'delete', 'id' => $row['id']))?>" onclick="return confirm('确认删除此门店吗？');return false;" style="background-color: #000; color:#fff;"><i class="fa fa-remove"></i></a><?php  } ?>
	                        </td>
	                    </tr>
	                    <?php  } } ?>
	                </tbody>	
