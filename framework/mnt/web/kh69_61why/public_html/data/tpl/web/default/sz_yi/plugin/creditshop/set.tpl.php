        ...
        <div class='panel-body'>
            <div class="form-group">
            	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">在会员中心显示积分兑换按钮</label>
                    <div class="col-sm-8 col-xs-12">
                          <?php if(cv('creditshop.set.save')) { ?>
                          <label class='radio radio-inline'><input type='radio' value='0' name='setdata[centeropen]' <?php  if($set['centeropen']==0) { ?>checked<?php  } ?> /> 关闭</label>
                          <label class='radio radio-inline'><input type='radio' value='1' name='setdata[centeropen]'  <?php  if($set['centeropen']==1) { ?>checked<?php  } ?> /> 显示</label>
                          <?php  } else { ?>
            	...
            	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                   <label class="col-xs-12 col-sm-4 col-md-4 control-label">线下兑换关键词</label>
                   <div class="col-sm-8 col-xs-12">
                           <?php if(cv('creditshop.set.save')) { ?>
            	...
            	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
	            	<label class="col-xs-12 col-sm-4 col-md-4 control-label">模板选择</label>
    		...
    		<div class="form-group">				<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
	                <label class="col-xs-12 col-sm-4 col-md-4 control-label">关注引导页面</label>	
	                <div class="col-sm-8 col-xs-12">	
	                          <?php if(cv('creditshop.set.save')) { ?>	
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
	                <label class="col-xs-12 col-sm-4 col-md-4 control-label">积分说明页面</label>	
	                <div class="col-sm-8 col-xs-12">	
	                           <?php if(cv('creditshop.set.save')) { ?>	
            	...
            	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				    <label class="col-xs-12 col-sm-4 col-md-4 control-label">分享标题</label>				
				    <div class="col-sm-8 col-xs-12">				
				           <?php if(cv('creditshop.set.save')) { ?>				
			...
			<div class="form-group">				<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
				    <label class="col-xs-12 col-sm-4 col-md-4 control-label">分享图标</label>				
				    <div class="col-sm-8 col-xs-12">				
				          <?php if(cv('creditshop.set.save')) { ?>				
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">			
				    <label class="col-xs-12 col-sm-4 col-md-4 control-label">分享描述</label>				
				    <div class="col-sm-8 col-xs-12">				
				             <?php if(cv('creditshop.set.save')) { ?>				
			    ...
			    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
	                <label class="col-xs-12 col-sm-4 col-md-4 control-label">底部版权</label>
	                <div class="col-sm-8 col-xs-12">
	                       <?php if(cv('creditshop.set.save')) { ?>
