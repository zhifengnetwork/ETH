	            ...
	            <div class='panel-body'>
	                <div class="form-group">
	                	<div class="col-lg-7 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">订单生成通知</label>
		                ...
		                </div>						<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
	                        <?php if(cv('sysset.save.notice')) { ?>
	                        ...
	                        <?php  } ?>						</div>
						<div class="col-lg-7 col-md-6 col-sm-6 col-xs-12">
	                    	<label class="col-xs-12 col-sm-3 col-md-3 control-label">通知方式</label>	
		                    <div class="col-sm-9 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
			...
			<div class="border_bg">
	            ...
	            <div class='panel-body'>
	                <div class="form-group">						<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
	                    	<label class="col-xs-12 col-sm-4 col-md-4 control-label">订单提交成功通知</label>	
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">	
	                    	<label class="col-xs-12 col-sm-4 col-md-4 control-label">自提订单提交成功通知</label>	
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
		                    ...
		                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">订单取消通知</label>		
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">	
	                    	<label class="col-xs-12 col-sm-4 col-md-4 control-label">订单发货通知</label>	
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
	                    	...
	                    	<label class="col-xs-12 col-sm-4 col-md-4 control-label">订单确认收货通知</label>	
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">	
		                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">退款申请通知</label>		
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
		                ...
		                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">		
		                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">退款申请驳回通知</label>		
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">	
		                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">会员升级通知(任务处理通知)</label>		
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">	
		                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">充值成功通知</label>		
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">	
		                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">充值退款通知</label>		
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">	
		                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">提现提交通知</label>		
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">	
		                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">提现成功通知</label>		
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">	
		                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">提现失败通知</label>		
		                    <div class="col-sm-8 col-xs-12">		
		                        <?php if(cv('sysset.save.notice')) { ?>		
