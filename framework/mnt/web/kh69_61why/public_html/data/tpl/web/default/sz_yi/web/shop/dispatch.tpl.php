        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr><td><?php  echo $item['id'];?></td>
                    <td><?php if(cv('shop.dispatch.edit')) { ?>
                    ...
                    <td style="text-align:left;">
                         <?php if(cv('shop.dispatch.view|shop.dispatch.edit')) { ?><a href="<?php  echo $this->createWebUrl('shop/dispatch', array('op' => 'post', 'id' => $item['id']))?>" class="btn btn-default btn-sm" title="<?php if(cv('shop.dispatch.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>" style="background-color: #ff5858; color:#fff;"><i class="fa fa-pencil"></i></a><?php  } ?>
                         <?php if(cv('shop.dispatch.delete')) { ?><a href="<?php  echo $this->createWebUrl('shop/dispatch', array('op' => 'delete', 'id' => $item['id']))?>" class="btn btn-default btn-sm" onclick="return confirm('确认删除此配送方式?')" title="删除" style="background-color: #000; color:#fff;"><i class="fa fa-times"></i></a><?php  } ?>
                    </td>
                </tr>
                <?php  } } ?>
                <tr>
                    <td colspan='9'>
                        ...
                        <a class='btn btn-primary' href="<?php  echo $this->createWebUrl('shop/dispatch',array('op'=>'post'))?>"><i class='fa fa-plus'></i> 添加配送方式</a>
            ...
            <div class="panel-body">
                <div class="form-group">
                	<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
	                    <label class="col-xs-12 col-sm-4 col-md-4 control-label">排序</label>
                	...
                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
	                    <label class="col-xs-12 col-sm-4 col-md-4 control-label"><span style="color:red">*</span>配送方式名称</label>
	                    <div class="col-sm-8 col-xs-12">
	                        <?php if( ce('shop.dispatch' ,$dispatch) ) { ?>
	            	...
	            	<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
		                <label class="col-xs-12 col-sm-4 col-md-4 control-label">是否为默认快递模板</label>
	            	...
	            	<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
		                <label class="col-xs-12 col-sm-4 col-md-4 control-label">计费方式</label>
              ...
              <div class="form-group dispatch0" >
                         <label class="col-xs-12 col-sm-3 col-md-1 control-label">配送区域</label>
                    <div class="col-sm-9 col-xs-12">
