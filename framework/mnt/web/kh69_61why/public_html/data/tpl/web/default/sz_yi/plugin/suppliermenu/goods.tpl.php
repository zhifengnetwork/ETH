...
<!--             <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <ul class="nav nav-arrow-next nav-tabs" id="myTab">
                 ...
                 <?php if(cv('suppliermenu.discount')) { ?>   <li><a href="#tab_discount">会员权限及折扣设置</a></li><?php  } ?>
				<?php  if(0) { ?>	<li><a href="#tab_share">分享及关注设置</a></li><?php  } ?>
                  <?php  if(0) { ?>  <li><a href="#tab_others">其他设置</a></li><?php  } ?>

                    <?php  if(p('verify')) { ?>
				<?php if(cv('suppliermenu.verify')) { ?>	<li><a href="#tab_verify">线下核销设置</a></li><?php  } ?>
                    <?php  } ?>


                    <?php if(cv('suppliermenu.distribution')) { ?>
                ...
                <div class="tab-content" style="overflow:inherit">
                   ...
                   <?php if(cv('suppliermenu.discount')) { ?> <div class="tab-pane" id="tab_discount"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('goods/discount', TEMPLATE_INCLUDEPATH)) : (include template('goods/discount', TEMPLATE_INCLUDEPATH));?></div><?php  } ?>
                  ...
                  <?php  if(0) { ?>  <div class="tab-pane" id="tab_others"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('goods/others', TEMPLATE_INCLUDEPATH)) : (include template('goods/others', TEMPLATE_INCLUDEPATH));?></div><?php  } ?>
                    ...
                    <?php  if(p('verify')) { ?>
                    <div class="tab-pane" id="tab_verify"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('goods/verify', TEMPLATE_INCLUDEPATH)) : (include template('goods/verify', TEMPLATE_INCLUDEPATH));?></div>
                    <?php  } ?>


                    <?php  if(p('commission') && !empty($com_set['level'])) { ?>
                    <div class="tab-pane" id="tab_sell"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('goods/commission', TEMPLATE_INCLUDEPATH)) : (include template('goods/commission', TEMPLATE_INCLUDEPATH));?></div>
                    <?php  } ?> 
