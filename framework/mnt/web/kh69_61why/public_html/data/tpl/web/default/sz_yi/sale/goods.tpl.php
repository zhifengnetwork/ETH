<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	    <label class="col-xs-12 col-sm-3 col-md-3 control-label">果实抵扣</label>	
	    <div class="col-sm-9">	
	       ...
	       <span class="help-block">虚拟商品为耕种果，实体商品为鲜果，如果设置0，则不支持果实抵扣</span>	
	          <?php  } else { ?>	
	    ...
	    <label class="col-xs-12 col-sm-3 col-md-3 control-label">金果抵扣</label>	
	    <div class="col-sm-9"> 	
	       <?php if( ce('shop.goods' ,$item) ) { ?>	
	        <div class='input-group'>	
	            <span class="input-group-addon">最多抵扣</span>	
	       ...
	       <span class="help-block">如果设置0，则支持全额抵扣，设置-1 不支持金果抵扣</span>	
	          <?php  } else { ?>	
	          <div class='form-control-static'>	
