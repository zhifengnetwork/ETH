            ...
            <div class='panel-body'>  
                <div class="form-group">
					<div class="col-xs-12 col-lg-7">
	                    <label class="col-xs-6 col-md-3 control-label">客服电话</label>
				...
				<div class="form-group">
                	<div class="col-xs-12 col-lg-7">
	                    <label class="col-xs-6 col-md-3 control-label">所在地址</label>
	                    <div class="col-xs-6 col-md-9">
	                        <?php if(cv('sysset.save.contact')) { ?>	
				...
				<div class="form-group">
                	<div class="col-xs-12 col-lg-7">
	                    <label class="col-xs-6 col-md-3 control-label">商城简介</label>
	                    <div class="col-xs-6 col-md-9">
	                        <?php if(cv('sysset.save.contact')) { ?>	
