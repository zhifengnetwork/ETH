...
<ul class="nav nav-tabs">
    <li <?php  if($_GPC['op']=='display' || empty($_GPC['op'])) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createPluginWebUrl('suppliermenu/designer')?>" >店铺装修</a></li>
   <?php  if($_GPC['op']=='post') { ?><li class="active"><a href="#">页面编辑</a></li><?php  } ?>
   <li ><a href="<?php  echo $this->createPluginWebUrl('suppliermenu/menu')?>" >自定义菜单</a></li>
   <?php  if(0) { ?><li ><a href="<?php  echo $this->createPluginWebUrl('designer/style')?>" >个人主页样式选择</a></li><?php  } ?>
</ul>
</div>
<?php  } ?>
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form action="./index.php" method="get" class="form-horizontal" role="form">
            ...
            <input type="hidden" name="method" value="designer" />
        ...
        <table class="table">
            ...
            <tbody>
                        ...
                        <tr pageid="<?php  echo $page['id'];?>">
                            ...
                            <td style=" text-align:  center;position:relative">
                               ...
                               <a href="javascript:;" data-url="<?php  echo $this->createPluginMobileUrl('designer',array('pageid'=>$page['id']))?>" class="js-clip" title="复制链接">复制链接</a>	   
                                - <a href="<?php  echo $this->createPluginWebUrl('suppliermenu/designer',array('op'=>'post','pageid'=>$page['id']))?>">编辑</a>
                ...
                <?php  } else { ?>
                    ...
                    <tr> 
                        <td style="text-align: center; line-height: 100px;" colspan="8">亲~您还没有添加自定义页面哦~您可以尝试 ↙ 左下角的 “<a href="<?php  echo $this->createPluginWebUrl('suppliermenu/designer', array('op' => 'post'))?>">添加一个新页面</a>”</td>
                    </tr>
                ...
                <?php  } ?>     
                    ...
                    <tr>
                        <td colspan="8">
                            <a class='btn btn-primary' href="<?php  echo $this->createPluginWebUrl('suppliermenu/designer', array('op' => 'post'))?>"><i class="fa fa-plus"></i> 添加一个新页面</a>
...
<script type="text/javascript">
    ...
    function delpage(id){
        if(confirm('此操作不可恢复，确认删除？')){
             $.ajax({
                type: 'POST',
                url: "<?php  echo $this->createPluginWebUrl('suppliermenu/designer',array('op'=>'api','apido'=>'delpage'))?>",
                data: {pageid:id},
    ...
    function setdefault(t,id,type){
        ...
        $.ajax({
            type: 'POST',
            dataType:'json',
            url: "<?php  echo $this->createPluginWebUrl('suppliermenu/designer',array('op'=>'api','apido'=>'setdefault'))?>",
    ...
    myModel.controller('FoxController', ['$scope', function($scope){
            ...
            $scope.ajaxselect =function(type){
                ...
                $.ajax({
                    type: 'post',
                    dataType:'json',
                    url: "<?php  echo $this->createPluginWebUrl('suppliermenu/designer',array('op'=>'api','apido'=>'selectlink'))?>",
            ...
            $scope.keyword = function(val,Eid){
                $.ajax({
                    type: 'post',
                    url: "<?php  echo $this->createPluginWebUrl('suppliermenu/designer',array('op'=>'api','apido'=>'selectkeyword'))?>",
            ...
            $scope.selectgood = function(Mid){
                ...
                $.ajax({
                    type: 'post',
                    dataType:'json',
                    url: "<?php  echo $this->createPluginWebUrl('suppliermenu/designer',array('op'=>'api','apido'=>'selectgood'))?>",
                    data: {kw:kw},
                    success: function(data){
                        $scope.selectGoods = [];
            ...
            $scope.save = function(n){
               ...
               if($(".fe-save-submit").data('saving')==1){
                    $.ajax({
                        type: 'POST',
                        url: "<?php  echo $this->createPluginWebUrl('suppliermenu/designer',array('op'=>'api','apido'=>'savepage'))?>",
                        ...
                        success: function(data){
                            if(n==2){
                                ...
                                setcookie(data);
                                if(!pageid){
                                    location.href = "<?php  echo $this->createPluginWebUrl('suppliermenu/designer',array('op'=>'post'))?>&pageid="+data;
                                }else{
                                    preview(data);
                                }
                            }else{
