<?php defined('IN_IA') or exit('Access Denied');?><div class="fe-panel-editor-title">页面信息设置<span style="font-size: 12px; margin-left: 10px;"></span></div>
...
<div class="fe-panel-editor-line">
    <div class="fe-panel-editor-name">悬浮机器人按钮</div>
    <div class="fe-panel-editor-con">
        <label style="cursor:pointer; margin-right: 10px;"><input type="radio" name="{{Edit.id}}_roll" value="1" ng-model="Edit.params.roll" /> 显示</label>
        <label style="cursor:pointer; margin-right: 10px;"><input type="radio" name="{{Edit.id}}_roll" value="0" ng-model="Edit.params.roll" /> 不显示</label>
    </div>
</div>
