    ...
    <div class='panel-body'>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-md-8 detail-logo">
                ...
                <span class="help-block">建议尺寸: 640 * 640 ，或正方型图片, <b>  虚拟商品为种植图片 </b></span>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-md-8">
                ...
                <span class="help-block">建议尺寸: 640 * 640 ，或正方型图片 <b></b></span>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-md-10 col-lg-8">
                ...
                <span class='help-block'>尽量填写完整，<b>有助于于商品销售的数据分析</b></span>
		...
		<div class="form-group">
            ...
            <label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">成熟果实</label>
            ...
            <div class="col-sm-9 col-md-10 col-lg-8">
                ...
                <div class="col-md-4 col-lg-4">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-addon">果实数量</span>

                        <input type="text" name="guoshi" id="guoshi" class="form-control" value="<?php  echo $item['guoshi'];?>" />
                 ...
                 <div class="col-md-4 col-lg-3">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-addon">收获</span>

                        <input type="text" name="cstime" id="cstime" class="form-control" value="<?php  echo $item['cstime'];?>" />
                ...
                <div class="col-md-4 col-lg-3">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-addon">收获次数</span>

                        <input type="text" name="cs" id="cs" class="form-control" value="<?php  echo $item['cs'];?>" />
                ...
                <span class='help-block'><b> 果树树苗必填，如若不填，成熟果实为0</b></span>
            ...
            <label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 control-label">增产比例</label>
            ...
            <div class="col-sm-9 col-md-10 col-lg-8">
                ...
                <div class="col-md-4 col-lg-3">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-addon">增产百分比</span>

                        <input type="text" name="zengchan" id="zengcan" class="form-control" value="<?php  echo $item['zengchan'];?>" />
                ...
                <span class='help-block'><b>增产产品必填，如若不填，增产为0</b></span>
