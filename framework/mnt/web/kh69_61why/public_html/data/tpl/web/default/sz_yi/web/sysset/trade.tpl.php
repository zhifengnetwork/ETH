...
<div class="main rightlist">
    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" >
        ...
        <div class="panel panel-default" style="background-color: transparent; border: none;">
        	<div class="border_bg">
				<div class="panel-heading">自动关闭未付款订单</div>
				<div class='panel-body'>
	                <div class="form-group">
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">自动关闭未付款订单天数</label>
		                    <div class="col-sm-9">
		                ...
		                <?php  if($_W['isfounder']) { ?>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<label class="col-xs-12 col-sm-3 col-md-3 control-label">自动关闭未付款订单执行间隔时间</label>
							<div class="col-sm-9">
								<?php if(cv('sysset.save.trade')) { ?>
								<div class="input-group">
			...
			<div class="border_bg">
				<div class="panel-heading">自动收货</div>
				<div class='panel-body'>
	
	                <div class="form-group">
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">自动收货天数</label>
		                    <div class="col-sm-9">
		                        <?php if(cv('sysset.save.trade')) { ?>
		                        <div class="input-group">
		                ...
		                <?php  if($_W['isfounder']) { ?>
		                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">自动收货执行间隔时间</label>
			                    <div class="col-sm-9">
			                        <?php if(cv('sysset.save.trade')) { ?>
			                        <div class="input-group">
			...
			<div class="border_bg">
				<div class="panel-heading">交易设置</div>
	            <div class='panel-body'>
	                <div class="form-group">
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">完成订单多少天内可申请退款</label>
		                    <div class="col-sm-9">
		                        <?php if(cv('sysset.save.trade')) { ?>
		                        <div class="input-group">
	                	...
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">退款说明</label>
		                    <div class="col-sm-9">
		                        <?php if(cv('sysset.save.trade')) { ?>
			...
			<div class="border_bg">
				<div class="panel-heading">余额设置</div>	
	            <div class='panel-body'>
	                <div class="form-group">
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">开启账户充值</label>
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">开启余额提现</label>
		                    <div class="col-sm-9 col-xs-12">
		                        <?php if(cv('sysset.save.trade')) { ?>
	                	...
	                	<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">余额提现限制</label>
		                    <div class="col-sm-9 col-xs-12">
		                        <?php if(cv('sysset.save.trade')) { ?>
			...
			<div class="border_bg">
				<div class="panel-heading">积分比例</div>	

	            <div class='panel-body'>
	                <div class="form-group">
	                    <label class="col-xs-12 col-sm-3 col-md-1 control-label">充值积分比例</label>
	                    <div class="col-sm-9 col-xs-12">
	                        <?php if(cv('sysset.save.trade')) { ?>
	                        <div class='input-group'>
	                        ...
	                        <div class='form-control-static'>
	                            <?php  if(empty($set['trade']['money'])) { ?>充值无积分
	                            <?php  } else { ?>
			...
			<div class="border_bg">
				<div class="panel-heading">共享收货地址</div>	
	            <div class='panel-body'>
	                <div class="form-group">
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">获取微信共享收货地址</label>
		                    <div class="col-sm-9 col-xs-12">
		                        <?php if(cv('sysset.save.trade')) { ?>
			...
			<?php  if($_W['isfounder']) { ?>
			<div class="border_bg">
				<div class="panel-heading">支付日志</div>
				<div class='panel-body'>
	                <div class="form-group">
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">支付回调日志</label>
		                    <div class="col-sm-9">
