        ...
        <div class="panel panel-default" style="background-color: transparent; border: none;">
	            ...
	            <div class='panel-body'>
	                <div class="form-group">
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">关注引导页</label>
		                ...
		                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                	<?php if(cv('sysset.save.follow')) { ?>
	                        <span class='help-block'>用户未关注的引导页面，建议使用短链接：<a target="_blank" href="http://www.dwz.cn" id="color_bg">短网址</a>
                            <?php  } ?>
		                </div>
	                </div>
	            </div>
            ...
            <div class="border_bg">
	            ...
	            <div class='panel-body'> 
	                <div class="form-group">
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">分享标题</label>
		                    <div class="col-sm-9 col-xs-12">
		                        <?php if(cv('sysset.save.follow')) { ?>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">分享连接</label>
		                    <div class="col-sm-9 col-xs-12">
		                        <?php if(cv('sysset.save.follow')) { ?>
	                ...
	                <div class="form-group">
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">分享图标</label>
		                    <div class="col-sm-9 col-xs-12">
		                        <?php if(cv('sysset.save.follow')) { ?>
	                	...
	                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		                    <label class="col-xs-12 col-sm-3 col-md-3 control-label">分享描述</label>
		                    <div class="col-sm-9 col-xs-12">
		                        <?php if(cv('sysset.save.follow')) { ?>
