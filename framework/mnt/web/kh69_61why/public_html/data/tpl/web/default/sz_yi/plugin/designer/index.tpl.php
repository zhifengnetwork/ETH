<?php defined('IN_IA') or exit('Access Denied');?><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('common/header', TEMPLATE_INCLUDEPATH)) : (include template('common/header', TEMPLATE_INCLUDEPATH));?><script language="javascript">require(['underscore']);</script> 
<!-- 导入CSS样式 --><link href="../addons/sz_yi/plugin/designer/template/imgsrc/designer.css" rel="stylesheet">
<!-- 头部选项卡 -->
<div class="ulleft-nav">
	<ul class="nav nav-tabs">
		<li class="active"><a href="<?php  echo $this->createPluginWebUrl('designer')?>" >店铺装修</a></li>
		...
		<li><a href="<?php  echo $this->createPluginWebUrl('designer/all_template')?>" >全部模版</a></li> 
	</ul>
</div>
<?php  if($op=='display') { ?>
<!-- 筛选区域 -->
...
<div class='panel panel-default'>
    ...
    <div class='panel-body'>
        <table class="table">
            <thead>
                <tr><th style="width:60px; text-align: center;">ID</th>
                    <th >页面名称</th>
                    ...
                    <th style="text-align: center;width: 26%">操作</th>
                </tr>
            </thead>
            <tbody>
                <?php  if(!empty($pages)) { ?>
                ...
                <?php  } else { ?>
                    ...
                    <tr>
                        <td style="text-align: center; line-height: 100px;" colspan="8">亲~您还没有添加自定义页面哦~您可以尝试 ↙ 左下角的 “<a href="<?php  echo $this->createPluginWebUrl('designer', array('op' => 'post'))?>">添加一个页面</a>”</td>
                    </tr>
                    <?php  } ?>
                <?php  } ?>
                <?php if(cv('designer.page.edit')) { ?>
                    <tr>
                        <td colspan="8">
                            <a class='btn btn-primary' href="<?php  echo $this->createPluginWebUrl('designer', array('op' => 'post'))?>"><i class="fa fa-plus"></i> 添加一个页面</a>
...
<style type="text/css">
	@media (max-width: 1366px) {
		.fe{    margin-left: 190px!important;}
	...
	.fe-panel-menu .fe_panel_menu_top{ width:auto;overflow:visible;height:55px;color:#303b49;font-size:16px;border-top:1px solid #fff;padding:0 10px;
	...
	.fe-save-submit1 {height: 40px; width: 100px; background: #f8ac59; border-radius: 3px; text-align: center; line-height: 40px; color: #fff; font-size: 16px; cursor: pointer; margin:10px 0px; float: left;}
	.fe-save-submit3 { margin-left: 10px; background: #fff url(../addons/sz_yi/plugin/designer/template/images/get_back.png) no-repeat center left; background-size: 30px 30px;text-indent: 30px; color: #000;
				height: 40px; width: 100px; border-radius: 3px; text-align: center; line-height: 40px; font-size: 16px; margin: 10px 0px 0px 10px; cursor: pointer;float: left;}	.fe-save-submit2{ color: #fff; background: #4bb5fb; margin: 10px 10px; }
</style>
	<div class="w1200">
		<div class='panel panel-default' ng-app="FoxEditor" style="background: #f2f2f2">
		    ...
		    <div class='panel-body' ng-controller="FoxController" style="position: relative;">
	        	<div class="fe-panel-menu" style=" width:288px; position:absolute; top:60px; border-radius: 5px; border: 1px #ccc solid; background: #E6E8EA; border-bottom: 1px solid #fff; box-shadow: 0px 4px 8px rgba(0,0,0,0.36);">
		    		...
		    		<div class="phonebox_functionbox_contentbox Tools_EditBox Tools_FunctionIcon" id="mobile_plugin_select" style="height: 390px; background: #fff;">
		        ...
		        <div class="fe-save">
		            <div class="fe-save-main" style="width: 1180px;">
		                ...
		                <div class="fe-save-submit" ng-click="save(1)" style=" margin: 10px 0px 0px;">保存</div> 
						<div class="fe-save-submit2" ng-click="save(2)">保存并预览</div>
                        <div class="fe-save-submit1" ng-click="save(3)">另存为模板</div>
	                    <div class="fe-save-submit2" ng-click="save(4)">另存为页面</div>
	...
	<script>
	    ...
	    myModel.controller('FoxController', ['$scope', function($scope){
	            ...
	            $scope.navs = [
	                ...
	                {id:'picture',name:'单图',params:{},data:[{id:'P0000000000001',imgurl:'../addons/sz_yi/plugin/designer/template/imgsrc/init-data/init-image-4.jpg',hrefurl:'',option:'0'}]},
	            ...
	            $scope.save = function(n){
                   ...
                   var del = "<?php  echo $datas['default'];?>";
