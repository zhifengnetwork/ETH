...
<style type="text/css">
    ...
    .addorder_good .info {width:50%;float:left; margin-left:-50px;margin-right:-60px;}

    .addorder_good .info .inner { margin-left:60px;margin-right:60px; }

    .addorder_good .info .inner .name {height:44px; width:100%; float:left; font-size:12px; color:#555;overflow:hidden;}
    ...
    <div class="addorder_good">
        ...
        <div class="good" data-totalmaxbuy="<%g.totalmaxbuy%>">
            ...
            <div class="price">
                ...
                <div class="cnum"><div class="leftnav">-</div><input type="text" class="shownum"  readonly value="<%g.total%>" /><div class="rightnav">+</div></div>
...
<?php  if(!empty($order_formInfo)) { ?>
    ...
    <%if deductcredit>0 || deductcredit2>0  %>
     ...
     <div class="addorder_price" style="margin-top:5px;">
            ...
            <div class="line" style="line-height:26px;"><d id="deductcredit_info" fre="<%money1%>" pre="<%deductcredit%>"><%deductcredit%></d> <% if goods[0].type==2%>耕种果可抵扣<%else if goods[0].type==1 %>鲜果可抵扣<%/if%> <d id="deductcredit_money" style='color:#ff6600'><%deductmoney%></d> 元
            ...
            <div class="line" style="line-height:26px;">鲜果可抵扣 <d id="deductcredit2_money" style='color:#ff6600'><%deductcredit2%></d> 元
    ...
    require(['tpl', 'core'], function(tpl, core) {
        ...
        $('#confirm_container').html(tpl('tpl_confirm_info', json.result));
           ...
           $('.leftnav').click(function(){
                ...
                // 标记
                 var pric = $('#deductcredit_info').html();
                  var deductprice12 = $("#deductcredit_info").attr('pre');
                  // var deductprice13 = $("#deductcredit_info").attr('fre');

                    pric = num * deductprice12; 
                $('#deductcredit_money').html(pric);
                $('#deductcredit_info').html(pric);
             ...
             $('.rightnav').click(function(){
                ...
                $('.discountprice').html( discountprice.toFixed(2)*num );
     ...
     $('.shownum').blur(function(){
	   ...
	   <?php  } ?>
            ...
            totalprice = totalprice - enoughprice + dispatchprice*num;
            ...
            if($("#deductcredit").length>0){
                ...
                if($("#deductcredit").attr('on')=='1'){
                    ...
                    // 标记
                 deductprice = parseFloat( $("#deductcredit_money").html() );
	       ...
	       diydata:diydata,
            ...
            if($("#deductcredit").length>0){
                ...
                if($("#deductcredit").attr('on')=='1'){
                      ...
                      data.deduct = 1;       
                         data.prc = $('#deductcredit_money').html();
	  ...
	  <?php  } ?>
            ...
            core.json('order/confirm', data, function(create_json) {
                ...
                }else if(create_json.status==5){

                	$('.paysub').html('确认订单').removeAttr('submitting');

                    core.tip.show("您没有土地可以种植了，快分享商城给您的好友赚取土地吧！")
