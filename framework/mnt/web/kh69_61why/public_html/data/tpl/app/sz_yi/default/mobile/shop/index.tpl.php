...
<script id='tpl_index' type='text/html'>
    ...
    <div class="top">
        <div class="bgimg"><img src="<?php  if($this->yzShopSet['img']) { ?><?php  echo $_W['siteroot'] . "attachment/" . $this->yzShopSet['img']?><?php  } else { ?>../addons/sz_yi/template/mobile/default/static/images/bg.jpg<?php  } ?>"></div>
<!--        <div class="list" onclick="location.href='<?php  echo $this->createMobileUrl('shop/category')?>'"><i class="fa fa-list"></i> 分类</div>-->
        <div class="topbar">
            
            <div class="logo"><img src="<?php  if($this->yzShopSet['logo']) { ?><?php  echo $_W['siteroot'] . "attachment/" . $this->yzShopSet['logo']?><?php  } else { ?>../addons/sz_yi/template/mobile/default/static/images/logo.png<?php  } ?>"></div>
      ...
      $.ajax({
        ...
        success: function (json) {
          if(json.status==0){
            ...
            alert(json.result.location.lng);
            alert(json.result.location.lat);
            require(['tpl', 'core'], function(tpl, core) {
              core.json('shop/detail', {
                    lng: json.result.location.lng,
                    lat: json.result.location.lat,
                    act: b_api
                   }, function(json) { 
            ...
            $.ajax({
              type:"POST",
              data:{lng:json.result.location.lng,lat:json.result.location.lat},
              url:"<?php  echo $this->createMobileUrl('shop/index')?>",
              success: function (json) {
