...
.cart_good .info .inner .optionsel {height:30px; float:left; line-height:30px; font-size:14px; color:#999; border-bottom:1px solid #999;}
...
.cart_good .other .num {height:30px; width:80px; border:1px solid #e2e2e2; margin-top:5px;}
...
.cart_pay {float:left;height:54px; width:94%; padding: 0 3%; background:#eee; border-top:1px solid #e1e1e1; position:fixed; bottom:0px; left:0px; z-index: 9999;}
