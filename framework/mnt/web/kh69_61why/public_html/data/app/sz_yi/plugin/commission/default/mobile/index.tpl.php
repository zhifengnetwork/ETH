...
<script id='tpl_main' type='text/html'>
    ...
    <div class="top">
        <div class="top_1">
            <div class="text">
          <?php  echo $this->set['texts']['commission_total']?>：<%member.commission_total1%> 元<br><?php  echo $this->set['texts']['commission_ok']?>（元）</div>
    ...
    <div class="menu">  
        <a href="<?php  echo $this->createPluginMobileUrl('commission/withdraw')?>"><div class="nav nav1"><i class="fa fa-cny fa-3x" style="color:#ff9901;"></i><div class="title"><?php  echo $this->set['texts']['commission1']?></div><div class="con"><span><%member.commission_total1%></span> 元</div></div></a>
