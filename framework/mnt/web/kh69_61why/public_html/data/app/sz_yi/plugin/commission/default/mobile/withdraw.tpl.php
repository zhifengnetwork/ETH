...
<script id='tpl_main' type='text/html'>
    ...
    <div class="gold_num" style="border:0px;height:70px">
        <div class="nav"><div class="title"><?php  echo $this->set['texts']['commission_total']?></div><div class="num" ><%member.commission_total%><!--<%member.commission_ok%>--></div><div class='tip'>所有<?php  echo $this->set['texts']['commission']?></div></div>
