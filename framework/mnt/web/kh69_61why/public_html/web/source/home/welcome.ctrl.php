...
$dos = array('platform', 'site', 'mc', 'setting', 'ext', 'solution','mall', 'fenxiao', 'supplier', 'bonus', 'cancel', 'authority', 'finance', 'statistics','suppliermenu');
$do = in_array($do, $dos) ? $do : 'platform';
$title = array('platform'=>'公众平台','site'=>'微站功能','mc'=>'会员及会员营销','setting'=>'功能选项','ext'=>'扩展功能','solution'=>'行业功能','mall'=>'商城系统','fenxiao'=>'分销系统','supplier'=>'供应链管理','bonus'=>'分红管理','cancel'=>'线下核销','authority'=>'分配权限','finance'=>'财务管理','statistics'=>'数据统计','suppliermenu'=>'供应商操作');
