...
class TaobaoModel extends PluginModel 
{
	...
	public function alibaba($itemid, $cates, $merchid = 0) 
	{
		...
		if (true) 
		{
			...
			$html = file_get_contents("http://m.1688.com/offer/573244909724.html");
