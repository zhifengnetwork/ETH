...
class Plugin_EweiShopV2Model 
{
	...
	public function getList($status = '') 
	{
		...
		unset($cv);
		$arr['biz'] = [
			1 => $list['biz']['plugins'][5],
			2 => $list['biz']['plugins'][1],
			4 => $list['biz']['plugins'][2],
			5 => $list['biz']['plugins'][4]
		];
		$arr['sale'] = [
			1 => $list['sale']['plugins'][5],
			2 => $list['sale']['plugins'][1],
			4 => $list['sale']['plugins'][2],
			7 => $list['sale']['plugins'][4],
			5 => $list['sale']['plugins'][7],
			6 => $list['sale']['plugins'][3],
			3 => $list['sale']['plugins'][6]
		];
		$arr['tool'] = [
			1 => $list['tool']['plugins'][5],
			2 => $list['tool']['plugins'][1],
			4 => $list['tool']['plugins'][2],
			5 => $list['tool']['plugins'][4]
		];
		// var_dump($arr);
