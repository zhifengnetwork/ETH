...
class Fullback_EweiShopV2Page extends MobileLoginPage 
{
	public function main() 
	{
        ...
        if($_GPC['type'] == '0'){
            $result = pdo_fetchall("select * from ".tablename("ewei_shop_receive_hongbao")."where uniacid=:uniacid and openid=:openid order by time desc",array(':uniacid'=>$_W['uniacid'],':openid'=>$_W['openid']));
        }
