...
class Info_EweiShopV2Page extends MobileLoginPage 
{
	...
	public function submit() 
	{
		...
		{	
			...
			$arr = array('realname' => trim($memberdata['realname']),'idnumber'=>trim($memberdata['idnumber']),'numberfile'=>trim($memberdata['numberfile']),'weixin' => trim($memberdata['weixin']), 'birthyear' => intval($memberdata['birthyear']), 'birthmonth' => intval($memberdata['birthmonth']), 'birthday' => intval($memberdata['birthday']), 'province' => trim($memberdata['province']), 'city' => trim($memberdata['city']), 'datavalue' => trim($memberdata['datavalue']), 'mobile' => trim($memberdata['mobile']));
			// show_json($arr);
