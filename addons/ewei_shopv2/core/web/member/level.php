...
class Level_EweiShopV2Page extends WebPage 
{
	...
	protected function post() 
	{
		...
		if ($_W['ispost']) 
		{
			...
			$data = array('uniacid' => $_W['uniacid'], 'level' => intval($_GPC['level']), 'fenhong' => intval($_GPC['fenhong']), 'jifen' => $_GPC['jifen'], 'levelname' => trim($_GPC['levelname']), 'ordercount' => intval($_GPC['ordercount']), 'ordermoney' => $_GPC['ordermoney'], 'discount' => trim($_GPC['discount']), 'enabled' => $enabled);
