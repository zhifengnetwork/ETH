	...
	if($ispost) {
		...
		if(empty($error)) {
			...
			if($_POST['type'] == 'remote') {
				...
				if($ins['error']) {
					die('<script type="text/javascript">alert("链接智放更新服务器失败, 错误为: ' . $ins['error'] . '！");history.back();</script>');
				}
				$archive = $ins['files'];
				if(!$archive) {
...
VER;
			...
			if(file_exists(IA_ROOT . '/index.php') && is_dir(IA_ROOT . '/web') && file_exists($verfile) && file_exists($dbfile)) {
				...
				die('<script type="text/javascript">alert("你正在使用本地安装, 但未下载完整安装包, 请从智放官网下载完整安装包后重试.");history.back();</script>');
			}
...
function remote_install() {
	...
	$pars['type'] = 'install';
	$pars['product'] = '';
	$url = 'http://rrv2.zhifun.cc/aip.php';
...
<html lang="zh-cn">
	...
	<body style="background-color:#00A194;">
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation"><a href="http://www.zhifun.cc">智放官网</a></li>
					<li role="presentation"><a href="http://bbs.zhifun.cc">智放论坛</a></li>
				</ul>
				<img src="web/resource/images/install.png" />
			</div>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="http://www.zhifun.cc">关于智放</a> &nbsp; &nbsp; <a href="http://www.zhifun.cc">智放帮助</a> &nbsp; &nbsp; <a href="http://shop149681021.taobao.com">购买授权</a>
				</div>
				<div class="text-center">
				    Powered by 智放微信营销系统CMS企业版 © 2017-2018 
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2017-2018智放科技保留所有权利。 </h3>
				<p>
					感谢您选择智放 - 微信营销系统CMS企业版（以下简称智放，智放基于 PHP + MySQL的技术开发，全部源码开放。 <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于智放微信营销系统任何版本，智放官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					<ol>
						<li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
						<li>您可以在协议规定的约束和限制范围内修改智放源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					...
					<ol>
						...
						<li>未经官方许可，禁止在智放的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
				...
				<p>
					...
					<ol>
						...
						<li>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装智放，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</li>
		...
		<form class="form-inline" role="form" method="post">
			<ul class="pager">
				...
				<li class="previous"><a href="javascript:;" onClick="if(jQuery(':checkbox:checked').length == 1){jQuery('form')[0].submit();}else{alert('您必须同意软件许可协议才能安装！')};"><font color="#00A194">继续 <span class="glyphicon glyphicon-chevron-right"></span></a></li>
			</ul>
		</form>
EOF;
	tpl_frame();
...
function tpl_install_env($ret = array()) {
	if(empty($ret['continue'])) {
		...
		$continue = '<li class="previous"><a href="javascript:;" onClick="$(\'#do\').val(\'continue\');$(\'form\')[0].submit();"><font color="#00A194">继续 <span class="glyphicon glyphicon-chevron-right"></span></a></li>';
	}
	echo <<<EOF
		<div class="panel panel-default">
		...
		<div class="alert alert-info">系统要求智放整个安装目录必须可写, 才能使用智放所有功能。</div>
		<div class="panel panel-default">
		...
		<form class="form-inline" role="form" method="post">
			...
			<ul class="pager">
				<li class="previous"><a href="javascript:;" onClick="$('#do').val('back');$('form')[0].submit();"><font color="#00A194"><span class="glyphicon glyphicon-chevron-left"></span> 返回</a></li>
				{$continue}
			</ul>
		</form>
EOF;
...
function tpl_install_db($error = '') {
	...
	<form class="form-horizontal" method="post" role="form">
		...
		<ul class="pager">
			<li class="previous"><a href="javascript:;" onClick="$('#do').val('back');$('form')[0].submit();"><font color="#00A194"><span class="glyphicon glyphicon-chevron-left"></span>返回</a></li>
			<li class="previous"><a href="javascript:;" onClick="if(check(this)){jQuery('#do').val('continue');if($('input[name=type]').val() == 'remote'){alert('在线线安装时，安装程序会下载精简版快速完成安装，完成后请务必注册云服务更新到完整版。')}$('form')[0].submit();}"><font color="#00A194">继续 <span class="glyphicon glyphicon-chevron-right"></span></a></li>
		</ul>
	</form>
	<script>
		var lock = false;
...
function tpl_install_finish() {
	...
	<div class="alert alert-success">
		恭喜您!已成功安装“智放-微信营销系统CMS企业版，您现在可以: <a target="_blank" class="btn btn-success" href="./web/index.php">访问网站首页</a>
	</div>
EOF;
	tpl_frame();
}
